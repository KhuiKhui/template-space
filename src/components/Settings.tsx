...
function Settings() {
  ...
  return (
    <div className="z-[1] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-left w-[350px] h-[450px] border-black dark:border-white border-2 p-[8px]">
      <div className="flex flex-col items-center">
        ...
        <div className="grid grid-rows-5 grid-cols-2 gap-3 w-full">
          ...
          <button
            ...
            className="border-black dark:border-white border-dashed border-2 w-[50px] hover:bg-[#F5F5F5] justify-self-center"
          >
          ...
          <button
            ...
            className="border-black dark:border-white border-dashed border-2 w-[50px] h-fit hover:bg-[#F5F5F5] justify-self-center"
          >
